...
#warning Add crime rating increase if executed noble
        ...
        private bool peasant_revenge_hero_last_words_condition(Hero hero)
        {
            ...
            if (currentRevenge.quest_Results.Contains(PeasantRevengeData.quest_result.party_no_decision))
            {
                ...
                {
                    text = new TextObject("{=PRev0165}The clan leaders are always imune to crimes.");
                }
            ...
            else if (currentRevenge.quest_Results.Contains(PeasantRevengeData.quest_result.criminal_killed))
            {
                ...
                {
                    text = new TextObject("{=PRev0158}Hope the twat is happy with all the treasures.");
                }
                else if (PRev0165)
                {
            ...
            else if (currentRevenge.quest_Results.Contains(PeasantRevengeData.quest_result.accused_hero_killed))
            {
                ...
                if (PRev0151)
                {
                    text = new TextObject("{=PRev0159}This bastard deserved his death.");
                }
                else if (PRev0152)
                {
                ...
                {
                    text = new TextObject("{=PRev0161}The bitch run out of luck this time.");
                }
                else if (PRev0150)
                {
                ...
                {
                    text = new TextObject("{=PRev0164}Such a shamefull end for the greedy bastart.");
                }
                else if (PRev0165)
                {
