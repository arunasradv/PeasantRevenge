...
namespace PeasantRevenge
{
    public class ReparationsBarterable : Barterable
    {
        ...
        public override TaleWorlds.Core.ImageIdentifiers.ImageIdentifier GetVisualIdentifier()
        {

            return new TaleWorlds.Core.ImageIdentifiers.ItemImageIdentifier(new ItemObject("gold"));
