...
- Hero, who had the criminal hero as a prisoner, may demand "lost ransom". Dialog options are:
 ...
 3. Dialogue for notable peasant to encourage them to initiate the peasant revenge. Notable peasant dialogue options are:
...
- The notable peasant (revenger) will initiate dialogue with a mobile party what has the criminal as a prisoner. And will demand criminal's head off or pay the reparation (reparation is scaled to hearts count of the village).
...
- Relations
  ...
  - Player does not get relations penalties if notable peasant behead the criminal hero. (**not implemented**) Player relations penalties can be set in the configuration file (see relationChangeForPlayerWhenNotableExecutedTheCriminal).
## Configuration:
